...
public sealed class SeriesTests
{
    ...
    public void AddArticle_RejectsOccupiedPosition()
    {
        ...
        series.AddArticle(Article.Create("test-owner", "en", CreatedAt, "First article"), 1, CreatedAt);

        Assert.Throws<InvalidOperationException>(
            () => series.AddArticle(Article.Create("test-owner", "en", CreatedAt, "Second article"), 1, CreatedAt));
    }
    ...
    public void AddArticle_RejectsNonPositivePosition()
    {
        ...
        Assert.Throws<ArgumentOutOfRangeException>(
            () => series.AddArticle(Article.Create("test-owner", "en", CreatedAt, "Article"), 0, CreatedAt));
    }
}
