...
namespace GaifulinLab.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260916120000_SplitArticleViewsByLocalization")]
    partial class SplitArticleViewsByLocalization
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
                    ...
                    b.ToTable("article_localizations", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_article_localizations_published_content", "\"Status\" <> 'Published' OR (\"PublishedAt\" IS NOT NULL AND \"Slug\" IS NOT NULL AND length(btrim(\"Title\")) > 0 AND length(btrim(\"Html\")) > 0)");
            ...
            modelBuilder.Entity("GaifulinLab.Domain.Articles.ArticleView", b =>
                {
                    ...
                    b.HasKey("ArticleLocalizationId", "VisitorHash");
            ...
            modelBuilder.Entity("GaifulinLab.Domain.Pdf.PdfDownloadUsage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("PdfExportJobId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserId", "PdfExportJobId", "RelativePath", "Period")
                        .IsUnique()
                        .HasDatabaseName("ux_pdf_download_usage_file");

                    b.ToTable("pdf_download_usages", (string)null);
                });
            ...
            modelBuilder.Entity("GaifulinLab.Infrastructure.Authentication.ApplicationUser", b =>
                {
                    ...
                    b.Property<int>("PdfSubscriptionTier")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GaifulinLab.Infrastructure.Authentication.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GaifulinLab.Domain.Articles.ArticleView", b =>
                {
                    b.HasOne("GaifulinLab.Domain.Articles.ArticleLocalization", null)
                        .WithMany()
            ...
            modelBuilder.Entity("GaifulinLab.Infrastructure.Authentication.RefreshToken", b =>
                {
                    b.HasOne("GaifulinLab.Infrastructure.Authentication.ApplicationUser", "User")
                        .WithMany()
